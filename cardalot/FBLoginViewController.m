...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    [[DeckController sharedInstance] addCardWithTitle:@"How to Use Cardalot" andAnswer:@"Add new decks by clicking \"Enter a New Deck\". \n\nAdd new cards to a deck clicking the + button. \n\nEnter Study Mode by pressing the \"Study\" at the top and Quiz Mode by pressing the \"Quiz\". \n\nIn Study Mode, you see both the front and the back at the same time. In Quiz Mode, you only see the front and you'll have to recall what's on the back. Afterwards, you can check your progress in the menu bar." toDeckWithNameTag:@"Click here first!"];
